...
private val DarkColorScheme = darkColorScheme(
    primary = MoneroOrange,
    onPrimary = Color.White,
    primaryContainer = MoneroOrange.copy(alpha = 0.2f).compositeOver(DarkBackground),
    ...
    tertiary = GreenDark,
    onTertiary = Color.White,
    tertiaryContainer = GreenDark.copy(alpha = 0.2f).compositeOver(DarkBackground),
    ...
    error = RedDark,
    onError = Color.White,
    errorContainer = RedDark.copy(alpha = 0.2f).compositeOver(DarkBackground),
